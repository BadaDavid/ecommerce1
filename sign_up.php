        ...
        <div class="container mt-5">
                <form action="sign_up.php" method="POST" class="form-controls shadow signup_form form2 col-md-10">
                    ...
                    <div class="row mx-auto">
                        ...
                        <input type="email" name="" placeholder="Enter Your Email Here" name="email" required maxlength="40" class="form-control ml-4 mr-5 col-md-9">
                        <br><br>
                        ...
                        <input type="password" name="" class="form-control col-md-9 ml-4 mr-3 mt-3" name="password" required placeholder="Enter Password">
                        <br><br>
                        <label for="password" class="form-label ml-4 mt-3">Confirm Password:</label>
                        <input type="password" name="" class="form-control col-md-9 ml-4 mt-3" name="confirm_password" required placeholder="Re-enter Password">
                    </div>
